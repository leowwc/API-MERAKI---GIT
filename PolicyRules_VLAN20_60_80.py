...
for listNetwork in responseNetJson:
    ...
    if listNetwork["name"] in nomes:
        ...
        "firewallAndTrafficShaping": {
            ...
            "l3FirewallRules": [
                {
                    "comment": "Block Wifi Free e VLAN Cameras_Seg",
                    "policy": "deny",
                    "protocol": "any",
                    "destPort": "Any",
                ...
                },
                {
                    ...
                    "protocol": "any",
                    "destPort": "Any",
                    "destCidr": "10." + x_y + ".152/29"
                },
                {
                    "comment": "Kiosk Remoto",
                    "policy": "allow",
                    "protocol": "any",
                    "destPort": "Any",
                    "destCidr": "10." + x_y + ".16/29"
                },
                {
                    "comment": "Kiosk Remoto",
                    "policy": "allow",
        ...
        "bonjourForwarding": {
         ...
         if responseUpdate.status_code == 201:
          print("GPolice Incluida com sucesso !!!")
         else:
         ...
         print("Ocorreu um erro na busca de VLAN.")
